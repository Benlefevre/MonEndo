...
class FertilityCalendar(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private fun createCalendarDays() {
        for (index in 1..6) {
            calendarDays.add(CalendarDay(dividedWidth, 1, dividedHeight, index))
            calendarDays.add(CalendarDay(dividedWidth, 2, dividedHeight, index))
            calendarDays.add(CalendarDay(dividedWidth, 3, dividedHeight, index))
            calendarDays.add(CalendarDay(dividedWidth, 4, dividedHeight, index))
            calendarDays.add(CalendarDay(dividedWidth, 5, dividedHeight, index))
            calendarDays.add(CalendarDay(dividedWidth, 6, dividedHeight, index))
            calendarDays.add(CalendarDay(dividedWidth, 7, dividedHeight, index))
        }
